        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvoiceNr = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "123456A", "Huseyn", "Bayramov", "+01234568" });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "ClientUniqueId", "Name", "Surname", "TelephoneNr" },
                values: new object[] { 2, "123456B", "Tural", "Ahmadov", "+05484412" });
